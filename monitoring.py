...
# =====================================================================
#  WinKernel Fuzzer Controller  (TCP Socket IPC 재설계판 - 최종 수정본)
# =====================================================================

# ================= VM / vmrun Config =================
VMRUN_PATH = r"C:\Program Files (x86)\VMware\VMware Workstation\vmrun.exe"
VMX_PATH = r"D:\4_1_vacation\win11_VM\Windows 11 x64.vmx"
SNAPSHOT_NAME = "set_host"
VM_USER = "Administrator"
VM_PASS = "qhdksgkrrhk2@"
VM_ACCESS_PASS = "12345678"
...
HOST_WORKER_EXE = r"D:\4_1_vacation\WinKernel Primitive Scanner\WinKernel Primitive Scanner\VM_Shared_Folder\WinKernel_Primitive_Scanner.exe"
GUEST_LOCAL_DIR = r"C:\Fuzz"
GUEST_LOCAL_EXE = r"C:\Fuzz\WinKernel_Primitive_Scanner.exe"
...
# ================= 크래시 시드 영속(호스트 로컬) =================
HOST_SHARED_DIR = r"D:\4_1_vacation\WinKernel Primitive Scanner\WinKernel Primitive Scanner\VM_Shared_Folder"
...
LISTEN_HOST = "0.0.0.0"   
LISTEN_PORT = 51337       
HOST_IP_FOR_GUEST = "192.168.175.1"
