...
export namespace WinKernel::Logger {
    ...
    public:
        ...
        */
        static std::wstring GenerateSessionDirectoryName(const std::wstring& prefix = L".\\FuzzLogs_") {    // 매개 변수 부분의 문법은 Default Parameter입니다. 함수 내부에서 경로를 지정하지 않은 것은 유연성 때문입니다.
